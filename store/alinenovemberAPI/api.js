...
function modules_two_factor_authentication_enable_2fa_destroy(payload) {
  return alinenovemberAPI.delete(`/modules/two-factor-authentication/enable/2fa`);
}

function modules_two_factor_authentication_google_authenticator_qr_retrieve(payload) {
  return alinenovemberAPI.get(`/modules/two-factor-authentication/google/authenticator/qr`);
}
...
function modules_two_factor_authentication_verify_otp_create_2(payload) {
  return alinenovemberAPI.post(`/modules/two-factor-authentication/verify/otp/${payload.enable}`);
}
